...
<!-- Este es el titulo -->
    ...
    <div class="form_container">
        <div class="form_group">
            ...
            <label for="name" class="form_label"> Agregue la base del Rectangulo</label>
            <span class="form_line"></span>
    </div>
    <div class="form_group">
        <input type="surname"  name="altura" id="surname" class="form_input" placeholder="" >
        <label for="name" class="form_label" >Agregue la altura del Rectangulo</label>
        <span class="form_line"></span>
</div>
...
<!-- Este es el titulo -->
    ...
    <div class="form_container">
        <div class="form_group">
            <input type="text" name="longitud2" id="name" class="form_input" placeholder="" >
            <label for="name" class="form_label"> Agregue la longitud del Rectangulo</label>
            <span class="form_line"></span>
    </div>
</div>
 
<button type="submit" name="control" value="perimrec">Calcular</button>
